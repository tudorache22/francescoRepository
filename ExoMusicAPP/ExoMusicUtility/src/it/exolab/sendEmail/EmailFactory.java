...
public class EmailFactory {
	...
	public void settaggioMessageStandard(Utente utente) throws AddressException, MessagingException {
		...
		message.setText(StringheEmail.getText(utente));
	}
	...
	public void invioEmailStandard(Utente utente) {
		try {
			settaggioMessageStandard(utente);
